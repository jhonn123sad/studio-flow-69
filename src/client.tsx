...
function ClickDebugApp() {
  ...
  useEffect(() => {
    console.log('[CLICK DEBUG] App montou via client.tsx')
    ...
    >
      ...
      >
        <h1 style={{ fontSize: 28, margin: '0 0 12px' }}>
          Teste real de clique (client.tsx)
        </h1>
...
if (rootElement) {
  ...
  // Se o root não existir, talvez o framework use outro ID ou não tenha carregado o HTML ainda
